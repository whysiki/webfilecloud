...
class Status(Config):
    # HTTP status codes
    HTTP_200_OK: int = status.HTTP_200_OK
    HTTP_201_CREATED: int = status.HTTP_201_CREATED
    HTTP_204_NO_CONTENT: int = status.HTTP_204_NO_CONTENT
    HTTP_206_PARTIAL_CONTENT: int = status.HTTP_206_PARTIAL_CONTENT
    HTTP_400_BAD_REQUEST: int = status.HTTP_400_BAD_REQUEST
    HTTP_401_UNAUTHORIZED: int = status.HTTP_401_UNAUTHORIZED
    HTTP_403_FORBIDDEN: int = status.HTTP_403_FORBIDDEN
    HTTP_404_NOT_FOUND: int = status.HTTP_404_NOT_FOUND
    HTTP_409_CONFLICT: int = status.HTTP_409_CONFLICT
    HTTP_500_INTERNAL_SERVER_ERROR: int = status.HTTP_500_INTERNAL_SERVER_ERROR
    HTTP_503_SERVICE_UNAVAILABLE: int = status.HTTP_503_SERVICE_UNAVAILABLE
